 ...
 * `{ data, error, loading, reload }` shape the existing desktop/mobile UIs
 * already render with (error as a string, `loading`/`reload` names).
 *
 ...
 * want the full TanStack API (isFetching, refetch promises, …) can consume
 * the hook result directly instead.
 */
